...
// 			for(y of cityData[x]){
// 				if(result == ""){
// 					result = `${y.substring(0,1)}`;
// 				}else{
// 					result = `${result},${y.substring(0,1)}`;
// 				}
...
//     return object1;
// };
// convertToKeyValuePair("Key","Learining");
...
document.getElementById("name").innerHTML = "This is dynamic change... because JS is included...";
